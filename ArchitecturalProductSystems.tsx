...
const PRODUCTS = [
    ...
    },
    {
        ...
        name: "CURTAIN WALL SYSTEM", sub: '8" Nominal Unitized — LMI FL.#20148-2',
        dp: "+140 PSF", water: "15 PSF", span: "43.5 in", impact: "LMI/SMI", unitW: "60 in",
        tags: ["CURTAIN WALL", "FBC IMPACT", "COMMERCIAL"], model: "curtain", thermal: false,
        fbc: { code: "FBC 8000 (Unitized)", unit: '60" × 162"', design: "+100 / −140 PSF", rating: "Small & Large Missile", lmi: "FL#20149.2", smi: "FL#20149.3" },
        ...DEF,
    },
    {
        id: "6000", series: "6000 SERIES", chip: "WINDOW", sys: "WINDOW WALL",
        name: "WINDOW WALL SYSTEM", sub: '6" Frame — FBC Large & Small Missile',
        ...
        fbc: { code: "FBC 6000 (Single span)", unit: '61" × 120"', design: "+120 / −130 PSF", rating: "Small & Large Missile", lmi: "FL#20148.2", smi: "FL#20148.3" },
        ...DEF,
    },
    {
        id: "6001", series: "6001 SERIES", chip: "DOOR", sys: "DOORS",
        name: "SLIDING GLASS DOOR", sub: '6" Frame Sliding — FBC Impact',
        dp: "+100 PSF", water: "18 PSF", span: "48 in", impact: "LMI/SMI", unitW: "192 in",
        tags: ["SLIDING DOOR", "FBC IMPACT", "RESIDENTIAL"], model: "door2", thermal: false,
    ...
    },
    {
        ...
        dp: "+65 PSF", water: "15 PSF", span: "58.5 in", impact: "LMI/SMI", unitW: "288 in",
        tags: ["SLIDING DOOR", "THERMAL BREAK", "MULTI-TRACK"], model: "door3", thermal: true,
        fbc: { code: "FBC 6500 (Multi-track)", unit: '288" × 120"', design: "+65 / −80 PSF", rating: "Large Missile", lmi: "FL#13892.1", smi: "—" },
    ...
    },
    {
        ...
        dp: "+100 PSF", water: "15 PSF", span: "60 in", impact: "LMI/SMI", unitW: "240 in",
        tags: ["LIFT & SLIDE", "FBC IMPACT", "EUROPEAN HW"], model: "lift", thermal: true,
        fbc: { code: "FBC 7000 / 10000", unit: '240" × 144"', design: "+100 / −110 PSF", rating: "Large Missile", lmi: "FL#13895.1", smi: "—" },
    ...
    },
    {
        ...
        name: "SINGLE HUNG & FIXED WINDOW", sub: '3½" Thermally Broken — AAMA PG-65',
        dp: "+75 PSF", water: "12 PSF", span: "53.1 in", impact: "LMI/SMI", unitW: "53 in",
        tags: ["SINGLE HUNG", "FBC & AAMA", "THERMAL BREAK"], model: "singlehung", thermal: true,
        fbc: { code: "FBC 3500 (Single hung)", unit: '53" × 87"', design: "+75 / −80 PSF", rating: "Small & Large Missile", lmi: "FL#14521.1", smi: "FL#14521.2" },
        ...DEF, glazing: '7/16" laminated to 1" insulated laminated',
        config: "Single hung, fixed-over-vent", install: "Punched openings & ribbon",
    },
    {
        id: "3250", series: "3250 SERIES", chip: "WINDOW", sys: "WINDOW WALL",
        name: "CASEMENT, FIXED & PROJECT-OUT", sub: '3½" Thermally Broken — Multiple Configs',
        dp: "+75 PSF", water: "15 PSF", span: "48 in", impact: "LMI/SMI", unitW: "48 in",
        tags: ["CASEMENT", "FBC IMPACT", "THERMAL BREAK"], model: "window", thermal: true,
        fbc: { code: "FBC 3250 (Casement)", unit: '48" × 84"', design: "+75 / −80 PSF", rating: "Small & Large Missile", lmi: "FL#14522.1", smi: "FL#14522.2" },
        ...DEF, glazing: '3/4" laminated to 1" insulated laminated',
        config: "Casement, fixed-over, project-out", install: "Punched openings & subframe",
    },
    {
        id: "2500", series: "2500 SERIES", chip: "WINDOW", sys: "WINDOW WALL",
        name: "CASEMENT, FIXED & PROJECT-OUT", sub: '2½" Equal Leg — Structural Silicone',
        dp: "+120 PSF", water: "18 PSF", span: "48 in", impact: "LMI/SMI", unitW: "48 in",
        tags: ["CASEMENT", "FBC IMPACT", "STRUCTURAL SI"], model: "window2", thermal: false,
        fbc: { code: "FBC 2500 (Casement)", unit: '48" × 96"', design: "+100 / −120 PSF", rating: "Small & Large Missile", lmi: "FL#14523.1", smi: "FL#14523.2" },
        ...DEF, glazing: '1-3/16" structural silicone laminated',
        config: "Equal-leg casement, fixed configurations", install: "Punched openings & subframe",
    },
]
